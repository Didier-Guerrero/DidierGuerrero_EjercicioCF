...
namespace DidierGuerrero_EjercicioCF.Controllers
{
    public class BurgersController : Controller
    {
        private readonly DidierGuerrero_EjercicioCFContext _context;

        public BurgersController(DidierGuerrero_EjercicioCFContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'DidierGuerrero_EjercicioCFContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DidierGuerrero_EjercicioCFContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
